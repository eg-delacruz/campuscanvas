...
export async function successful_step_2_register_process(
  IP_Address,
  user,
  browserName
) {
  ...
  const serverEvent_0 = new ServerEvent()
    .setEventName('successful_step_2_register_process')
    .setEventTime(current_timestamp)
    .setUserData(userData_0)
    .setCustomData(customData_0)
    .setActionSource('website')
    .setEventSourceUrl('www.campuscanvas.net/auth/registro_step_2')
    .setEventId(uniqueID);
