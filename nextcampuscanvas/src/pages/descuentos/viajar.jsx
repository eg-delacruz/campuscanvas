...
const viajar = ({ initialCards }) => {
  const REQUIRED_CARDS = 'travel';
  ...
  return (
    <>
      ...
      <DisplayCardsByCategoryTemplate
        ...
        categoryDescription={
          'Explora todos nuestros descuentos de la categoría de viajes para estudiantes 👩‍🎓🧑‍🎓'
        }
      />
...
export async function getStaticProps() {
  const response = await axiosFetcher({
    ...
    method: 'get',
    extraHeaders: { required_cards: 'travel', page: 1, limit: 30 },
  });
