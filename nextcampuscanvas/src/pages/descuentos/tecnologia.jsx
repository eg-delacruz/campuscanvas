...
const tecnologia = ({ initialCards }) => {
  const REQUIRED_CARDS = 'technology';
  ...
  return (
    <>
      ...
      <DisplayCardsByCategoryTemplate
        ...
        categoryDescription={
          'Explora todos nuestros descuentos de la categoría de tecnología para estudiantes 👩‍🎓🧑‍🎓'
        }
      />
...
export async function getStaticProps() {
  const response = await axiosFetcher({
    ...
    method: 'get',
    extraHeaders: { required_cards: 'technology', page: 1, limit: 30 },
  });
