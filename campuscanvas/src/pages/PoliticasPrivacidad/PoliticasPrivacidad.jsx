      ...
      <section className='main'>
        <div className='main__container container'>
          ...
          <article>
            ...
            <strong>Titular: </strong> Campus Canvas, S.A. <br /> <br />
            <strong>CIF: </strong> X-65468548.6 <br /> <br />
            <strong>Domicilio social: </strong> Calle Unodos Nr. 25, Madrid,
            España <br /> <br />
            <strong>Registro público: </strong> Inscrita en el registro
            mercantil de Madrid, tomo1234, general 123 de la Sección general del
            libro de sociedades, folio 123, hoja número M-1234
            <br /> <br />
            <strong>Teléfono de contacto: </strong> 901 654 654
            <br /> <br />
          </article>
          ...
          <article>
            ...
            <ul>
              <li>
                Ejemplo 1 de finalidad: Lorem ipsum dolor sit amet, consectetur
                adipiscing elit. Quisque nisl eros, pulvinar facilisis justo
                mollis, auctor consequat urna. Morbi a bibendum metus. Donec
                scelerisque sollicitudin enim eu venenatis. Duis tincidunt
                laoreet ex, in pretium orci vestibulum eget. Class aptent taciti
              ...
              <li>
                Ejemplo 2 de finalidad: Lorem ipsum dolor sit amet, consectetur
                adipiscing elit. Quisque nisl eros, pulvinar facilisis justo
                mollis, auctor consequat urna. Morbi a bi
              </li>
              <li>
                Ejemplo 3 de finalidad: Lorem ipsum dolor sit amet, consectetur
                adipiscing elit. Quisque nisl eros, pulvinar facilisis justo
                mollis, auctor consequat urna. Morbi a bibendum metus. Donec
                scelerisque sollicitudin enim eu venenatis. Duis tincidunt
                laoreet ex, in pretium
              ...
              <li>
                Ejemplo 4 de finalidad: Lorem ipsum dolor sit amet, consectetur
                adipiscing elit. Quisque nisl eros, pulvinar facilisis justo
                mollis, auctor consequat urna. Morbi a bibendum metus. Donec
                scelerisque sollicitudin
              </li>
            ...
            <p>
              Para evitar la pérdida, manipulación, difusión o alteración de tus
              datos, Campus Canvas implementa las siguientes medidas
            </p>
            <ul>
              <li>
              ...
              <li>
                ...
                consectetur adipiscing elit. Quisque nisl eros, pulvinar
                facilisis justo mollis, auctor consequat urna. Morbi a bibendum
                metus. Donec scelerisque sollicitudin
              </li>
            </ul>
          </article>
          <article>
          ...
          <ul>
            <li>
              Ejemplo 1 de destinatario: Lorem ipsum dolor sit amet, consectetur
              adipiscing elit. Quisque nisl eros, pulvinar facilisis justo
              mollis, auctor consequat urna. Morbi a bibendum metus. Donec
            ...
            <li>
              Ejemplo 2 de destinatario: Lorem ipsum dolor sit amet, consectetur
              adipiscing elit. Quisque nisl eros, pulvinar facilisis justo
              mollis, auctor consequat urna. Morbi a bi.
            </li>
          </ul>
